defmodule ExpensyWeb.Components.FileField do
  @moduledoc """
  The `ExpensyWeb.Components.FileField` module provides a versatile and customizable component
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExpensyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExpensyWeb.Gettext, "errors", msg, opts)
    end
  end
end
