defmodule ExpensyWeb.Components.CheckboxField do
  @moduledoc """
  ExpensyWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
