defmodule ExpensyWeb.Components.Banner do
  @moduledoc """
  ExpensyWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
