defmodule ExpensyWeb.Components.Overlay do
  @moduledoc """
  The `ExpensyWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `ExpensyWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
