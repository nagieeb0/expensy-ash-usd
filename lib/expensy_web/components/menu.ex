defmodule ExpensyWeb.Components.Menu do
  @moduledoc """
  The `ExpensyWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `ExpensyWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import ExpensyWeb.Components.Accordion, only: [accordion: 1]
  import ExpensyWeb.Components.Button, only: [button_link: 1]
