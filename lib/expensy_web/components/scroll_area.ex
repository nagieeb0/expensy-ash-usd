defmodule ExpensyWeb.Components.ScrollArea do
  @moduledoc """
  The `ExpensyWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
