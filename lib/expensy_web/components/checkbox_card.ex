defmodule ExpensyWeb.Components.CheckboxCard do
  @moduledoc """
  The `ExpensyWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
