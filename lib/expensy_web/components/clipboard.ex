defmodule ExpensyWeb.Components.Clipboard do
  @moduledoc """
  The `ExpensyWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
