defmodule ExpensyWeb.Components.Stepper do
  @moduledoc """
  The `ExpensyWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `ExpensyWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
