defmodule ExpensyWeb.Components.Divider do
  @moduledoc """
  The `ExpensyWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `ExpensyWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
