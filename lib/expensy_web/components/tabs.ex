defmodule ExpensyWeb.Components.Tabs do
  @moduledoc """
  `ExpensyWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import ExpensyWeb.Components.Badge, only: [badge: 1]
