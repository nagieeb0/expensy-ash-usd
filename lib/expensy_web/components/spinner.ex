defmodule ExpensyWeb.Components.Spinner do
  @moduledoc """
  The `ExpensyWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `ExpensyWeb.Components.Spinner` module enables developers to provide
