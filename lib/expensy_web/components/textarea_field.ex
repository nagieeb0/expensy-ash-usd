defmodule ExpensyWeb.Components.TextareaField do
  @moduledoc """
  The `ExpensyWeb.Components.TextareaField` module provides a versatile and customizable textarea field component
